<?php
	...
	include_once('../configuration/database/function.php');
	$sql = "SELECT * FROM recipelist_t WHERE id='".$_GET['id']."'";
...
<body>
	...
	<div class="text-center" id="article_title">
				<h2><?= $row['name']?></h2>
		</div>
	</div>
	<div class="container wrapper">
		<div class="row contents">
			<section class="main col-md-9 col-sm-8">
				<article class="well well-sm">
				<img class="img-rounded img-article" src="../img/<?=$row['image']?>">
					<h4><?= $row['type']?></h4>
			...
			<section class="col-md-3 col-sm-4 hidden-xs">
				<div class="panel panel-info">
					<div class="panel-heading">
						<h3>អត្ថបទប្រហាក់ប្រហែល</h3>
					</div>
					<div class="panel-body">
						<?php recom($_GET['id'], $con, $row['type']); ?>
					</div>
				</div>
			</section>
			<div class="row contents">
			<section class="main col-sm-9">
				<article class="well well-sm">
						<div class="thumnail">
						<div class="caption"><h4 class="video_link">វីដេអូ</h4></div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3">
						<div class="caption" id="caption_pad">
							...
							<a class="credit" href="../home.html"><p>ទំព័រដើម</p></a>
	...
	<!-- <script>$("#topContainer").css("min-height",$(window).height());</script> -->
